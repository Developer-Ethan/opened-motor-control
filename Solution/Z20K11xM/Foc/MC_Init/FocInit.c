...
void Foc_Init(void)
{
    ...
    Foc.Smo_Ctrl.Factor1 = Q13(PWM_PERIOD * Motor_Param.PhaseRes_Base / Motor_Param.PhaseInd);
    Foc.Smo_Ctrl.Factor2 = Q13(PWM_PERIOD * Motor_Param.PhaseRes / Motor_Param.PhaseInd);
    Foc.Smo_Ctrl.SmoGain = Q14(SMO_GAIN);
    Foc.Smo_Ctrl.SmoErrWidth = Q14(SMO_ERRWIDTH);
    Foc.Smo_Ctrl.SmoSlope = (int16_t)(SMO_GAIN / SMO_ERRWIDTH);
    ...
    LoopCtrl.ClosedLoopCtrl.CurrLoop.Pi_D.Pid_Ki = (int16_t)(Foc.BandWidthPu_CurrLoop * Foc.PhaseRes * Foc.TsPu); // KI_CURRLOOP; 268
    LoopCtrl.ClosedLoopCtrl.CurrLoop.Pi_D.Pid_Kp = (int16_t)(Foc.BandWidthPu_CurrLoop * Foc.PhaseInd);            // KP_CURRLOOP; 5157
