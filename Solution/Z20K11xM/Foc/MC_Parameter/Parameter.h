...
#define TIME_ALIGN (300u)
#define TIME_OPENLOOP (500u)
/*board parameters*/
#define R_SHUNT (0.005f)
#define GAIN_AMP (10.0f)
#define ADC_VREF (5.0f)
#define RES_PULL (29.4f) // kohm
...
#define DEADTIME (0.6f)      // us
#define PWM_DELAY (0.4f)
#define MINWINDOW (0.6f)     // us
#define PWM_HOLD (PWM_DELAY + MINWINDOW)
#define ADC_CONV_TIME (1.1f) // us;f = 128m/4;time = f*(12.5+13.5)
/*motor parameters*/
#define POLE_PAIRS (5u)
#define RS_PHASE (0.025f)
#define LD_PHASE (0.00006f)
#define LQ_PHASE (0.00006f)
...
#define FLUX_RATE (float)(0.016f)//((1.414f * 7.66f / 1.732f) / (2 * _PI * ((1000 * POLE_PAIRS) / 60)))
#define VOLT_RATE (14.0f) // 36v/sqrt(3)
#define CURR_RATE (15.0f) // 14.5a
#define EFREQ_RATE (400.0f)

#define VOLT_BASE (float)(VOLT_RATE / 1.732)    // 17.96
#define CURR_BASE (1.5*CURR_RATE)                    // 14.14
#define OMEGA_BASE (float)(2 * _PI * EFREQ_RATE) // 1884
#define T_BASE (float)(1.0f / OMEGA_BASE)
...
/*foc parameters*/
#define STABLE_SCALE (int16_t)((MINWINDOW + ADC_CONV_TIME) * (SYSTEM_FREQ / (TIMER_CLOCK_PRESCALER_SET + 1)))
#define SHIFT_SCALE (int16_t)((PWM_HOLD + DEADTIME) * (SYSTEM_FREQ / (TIMER_CLOCK_PRESCALER_SET + 1)))
#define COEFF_CURR (int32_t)(((ADC_VREF / (GAIN_AMP * R_SHUNT)) / CURR_BASE) * 16384)
#define COEFF_VOLT (int32_t)(((ADC_VREF * (RES_PULL + RES_DOWN) / RES_DOWN) / VOLT_BASE) * 16384)

#define BANDWIDTH_PLLLOOP (200u)
...
#define KP_SPDLOOP (13000u)
#define KI_SPDLOOP (30u)
#define OUT_MAX_SPDLOOP (int16_t)(19660)
#define OUT_MIN_SPDLOOP (int16_t)(-OUT_MAX_SPDLOOP)

#define SPEED_TARGET_OPENLOOP (400.0f)//3 shunt 300
#define SPEED_SWITCH_OPENLOOP (200.0f)//3 shunt 200
#define SPEED_SLOPE (0.3f)
#define SPEED_CLOSEDLOOP (1000.0f)
#define ALIGN_CURR_OPENLOOP (2.5f)
#define ALIGN_CURR_SLOPE (0.04f)
#define ALIGN_ANGLE Q16(0.25f)
#define START_CURR_OPENLOOP (2.5f)
#define IFCURR_TARGET (2.5f)
#define IFCURR_SLOPE (0.002f)

#define UQ_LIMIT Q14(0.9f)
#define UD_LIMIT Q14(0.43f)
#define MODULE_COEFF Q15(0.577)
/*Observer parameters*/
#define SMO_GAIN (0.75f)
#define SMO_ERRWIDTH (0.15f)
#define BANDWIDTH_EMFLPF (200.0f)

#define GAIN_SVCM (0.8f)
#define ONE_SHUNT_ENABLE (1)
#define THREE_SHUNT_ENABLE (0)
