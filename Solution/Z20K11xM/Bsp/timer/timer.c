...
void HAL_setupPwms()
{
    ...
    /* GPIO config */
    PORT_PinmuxConfig(PORT_B, GPIO_4, PTB4_TIM0_CH4);
    PORT_PinmuxConfig(PORT_B, GPIO_5, PTB5_TIM0_CH5);

    PORT_PinmuxConfig(PORT_E, GPIO_8, PTE8_TIM0_CH6);
    PORT_PinmuxConfig(PORT_E, GPIO_9, PTE9_TIM0_CH7);

    PORT_PinmuxConfig(PORT_D, GPIO_15, PTD15_TIM0_CH0);
    PORT_PinmuxConfig(PORT_D, GPIO_16, PTD16_TIM0_CH1);
