 ...
 *
 */
void Svm_Ctr(SVM_DEF *pSvm, uint16_t Period, AXIS_DEF *pAxis)
{
	...
	Mod = 2 * Period;
    pSvm->ModulCoeff = (int16_t)(((Mod * SQRT_3 >> SHIFT_15BITS) << SHIFT_15BITS) / Foc.Sample_Volt);
    ...
    Tb = Ta + pSvm->T1;
    Tc = Tb + pSvm->T2;
    Ta = SATURATE(Ta, 0, Period);
    Tb = SATURATE(Tb, 0, Period);
    Tc = SATURATE(Tc, 0, Period);
    ...
    case (0u): // N 3
        ...
        pSvm->ComparePoint_1st_Down = Mod - pSvm->ComparePoint_1st_Up;
        pSvm->ComparePoint_2nd_Down = Mod - pSvm->ComparePoint_2nd_Up;
        pSvm->ComparePoint_3th_Down = Mod - pSvm->ComparePoint_3th_Up;
...
#endif
        pSvm->CompareValue_SimplePoint1 = pSvm->ComparePoint_1st_Up + pSvm->ShiftScale;
        pSvm->CompareValue_SimplePoint2 = pSvm->ComparePoint_2nd_Up + pSvm->ShiftScale;
        break;
...
#endif
        pSvm->CompareValue_SimplePoint1 = pSvm->ComparePoint_2nd_Up + pSvm->ShiftScale;
        pSvm->CompareValue_SimplePoint2 = pSvm->ComparePoint_1st_Up + pSvm->ShiftScale;
        break;
...
#endif
        pSvm->CompareValue_SimplePoint1 = pSvm->ComparePoint_2nd_Up + pSvm->ShiftScale;
        pSvm->CompareValue_SimplePoint2 = pSvm->ComparePoint_3th_Up + pSvm->ShiftScale;
        break;
...
#endif
        pSvm->CompareValue_SimplePoint1 = pSvm->ComparePoint_3th_Up + pSvm->ShiftScale;
        pSvm->CompareValue_SimplePoint2 = pSvm->ComparePoint_2nd_Up + pSvm->ShiftScale;
        break;
