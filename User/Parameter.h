...
#define PIOUT_MAX_PLLLOOP (19660)
#define PIOUT_MIN_PLLLOOP (-PIOUT_MAX_PLLLOOP)
#define IOUT_MAX_PLLLOOP (19660)
#define IOUT_MIN_PLLLOOP (-IOUT_MAX_PLLLOOP)

#define BANDWIDTH_CURRLOOP (300u)
#define KP_CURRLOOP (1000u)
#define KI_CURRLOOP (100u)
#define PIOUT_MAX_CURRLOOP (int32_t)(19660)
#define PIOUT_MIN_CURRLOOP (int32_t)(-PIOUT_MAX_CURRLOOP)
#define IOUT_MAX_CURRLOOP (int32_t)(19660)
#define IOUT_MIN_CURRLOOP (int32_t)(-IOUT_MAX_CURRLOOP)

#define KP_SPDLOOP (1000u)
#define KI_SPDLOOP (100u)
#define PIOUT_MAX_SPDLOOP (int32_t)(19660)
#define PIOUT_MIN_SPDLOOP (-PIOUT_MAX_SPDLOOP)
#define IOUT_MAX_SPDLOOP (int32_t)(19660)
